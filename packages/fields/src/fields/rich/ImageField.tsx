    ...
    >
      ...
      {def.imageUri ? (
        <div className="ms:relative ms:rounded-lg ms:border ms:border-msborder ms:bg-msbackground ms:p-4">
          ...
          <p className="ms:text-xs ms:font-medium ms:text-mstextmuted ms:mb-2">Preview</p>
          <div className="ms:flex ms:justify-center">
            <img
              src={def.imageUri}
        ...
        >
          <svg className="ms:w-10 ms:h-10 ms:text-mstextmuted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
