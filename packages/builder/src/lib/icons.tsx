...
export const ViewBigIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
...
export const ViewSmallIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const TextFieldsIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const SelectionFieldsIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const MatrixIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const RichContentIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const OrganizationIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const VEditorIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const PreviewIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const DragHandleIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const LogicIcon = React.memo(
  ({ className = '' }: IconProps) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
